    ...
    def set_coords(self):
        while True:
            try:
                ...
                if self.x not in range(1, 1001):
                    print(data.communicate("ERROR: Enter an integer in range 1-1000\n", "LIGHTRED_EX"))
                    continue
            except ValueError:
                print(data.communicate("ERROR: Enter an integer in range 1-1000\n", "LIGHTRED_EX"))
            else:
        ...
        while True:
            try:
                ...
                if self.y not in range(1, 101):
                    print(data.communicate("ERROR: Enter an integer in range 1-100\n", "LIGHTRED_EX"))
                    continue
            except ValueError:
                print(data.communicate("ERROR: Enter an integer in range 1-100\n", "LIGHTRED_EX"))
            else:
