...
class AssaultRifle(Weapon):
    def __init__(self, team, name, mf, ammo):
...
MCXVirtus = AssaultRifle(team=SWAT,  name="MCX Virtus",  mf=SIG,           ammo=30)
...
M9A3 = Pistol(       team=HECU, name="M9A3",                  mf=Beretta, ammo=17)
DesertEagle = Pistol(team=HECU, name="Desert Eagle Mark XIX", mf=IWI,     ammo=7)
FSMk2 = Pistol(      team=HECU, name="Five-SeveN Mk2",        mf=FN,      ammo=20)

P226 = Pistol(      team=SWAT, name="P226",          mf=SIG,   ammo=20)
Glock17 = Pistol(   team=SWAT, name="Glock 17 Gen5", mf=Glock, ammo=17)
USPCompact = Pistol(team=SWAT, name="USP Compact",   mf=H_K,   ammo=13)
...
class Heavy(Weapon):
    def __init__(self, team, name, mf, ammo, single_use=True):
        super().__init__(weapon_type="Heavy", team=team, name=name, manufacturer=mf, single_use=single_use)
        self.ammo = ammo


M134 = Heavy(team=HECU, name="M134 Minigun",   mf=GE,  ammo=3000)
NSV = Heavy( team=HECU, name="NSV 12.7mm HMG", mf=NSV, ammo=150)

M2HB = Heavy(team=SWAT, name="Browning M2HB",   mf=USA, ammo=100)
DShK = Heavy(team=SWAT, name="DShK 12.7mm HMG", mf=DS,  ammo=50)


class ERA(Weapon):
    def __init__(self, team, name, mf, ammo, single_use=False):
        super().__init__(weapon_type="ERA", team=team, name=name, manufacturer=mf, single_use=single_use)
        self.ammo = ammo


M72 = ERA(   team=HECU, name="M72 LAW",         mf=Nammo,    ammo=1, single_use=True)
FGM148 = ERA(team=HECU, name="FGM-148 Javelin", mf=Raytheon, ammo=1)
M4 = ERA(    team=HECU, name="Carl Gustaf M4",  mf=SBD,      ammo=1)

AT4 = ERA( team=SWAT, name="AT4",                         mf=SBD, ammo=84)
M320 = ERA(team=SWAT, name="M320 Grenade Launcher",       mf=H_K, ammo=1)
Mk19 = ERA(team=SWAT, name="Mk19 Mod 3 Grenade Launcher", mf=GD,  ammo=48)
...
M40A1 = SniperRifle(  team=HECU, name="M40A1",     mf=Remington, ammo=5)
Hecate2 = SniperRifle(team=HECU, name="Hecate II", mf=PGM,       ammo=7)
Scout = SniperRifle(  team=HECU, name="Scout",     mf=Steyr,     ammo=10)
