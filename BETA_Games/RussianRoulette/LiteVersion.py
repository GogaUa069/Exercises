...
class Game:
    ...
    def player_dead(self):
        self.clear_cmd()
        sleep(3)
        print(communicate("He's dead...", "LIGHTRED_EX"))
        sleep(3)
        print(communicate("Come on, we need to dispose of him.", "LIGHTRED_EX"))
        sleep(3)
        self.clear_cmd()
    ...
    def dealer_move(self):
        ...
        if bullet:
            ...
            print(communicate("Dealer alive. My buddy!", "LIGHTRED_EX"))
            shuffle(self.cylinder)
