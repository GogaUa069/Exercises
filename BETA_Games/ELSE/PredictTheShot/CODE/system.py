...
def get_data_path():
    ...
    return os.path.normpath(os.path.join(base_dir, "..", "UTILS", "data.yaml"))
...
class DataRemote:
    ...
    def set_params(self):
        ...
        if self.DATA["options_rate"]["shot"]["normal"] != 0 and self.DATA["options_rate"]["shot"]["normal"] != self.local_options_rate["shot"]:
        ...
        if self.DATA["options_rate"]["load"]["normal"] != 0 and self.DATA["options_rate"]["load"]["normal"] != self.local_options_rate["load"]:
        ...
        if self.DATA["options_rate"]["block"]["normal"] != 0 and self.DATA["options_rate"]["block"]["normal"] != self.local_options_rate["block"]:
        ...
        if self.DATA["options_rate"]["deflect"]["normal"] != 0 and self.DATA["options_rate"]["deflect"]["normal"] != self.local_options_rate["deflect"]:
