...
# CARGO TRANSPORT
trucks_option = system.Option("TRUCKS", system.coming_soon)  # ***
trains_option = system.Option("TRAINS", system.coming_soon)  # ***
cargo_aircraft_option = system.Option("CARGO AIRCRAFT", system.coming_soon)  # ***
from_cargo_transport_to_logistics = system.Option(system.underlined_text("BACK - LOGISTICS"), system.pass_func)
...
# URBANISATION
mines_option = system.Option("MINES", system.coming_soon)  # ***
fabrics_option = system.Option("FABRICS", system.coming_soon)  # ***
from_urbanisation_to_logistics = system.Option(system.underlined_text("BACK - LOGISTICS"), system.pass_func)
...
loan_option = system.Option("LOAN", system.coming_soon)  # ***
from_economy_to_logistics = system.Option(system.underlined_text("BACK - LOGISTICS"), system.pass_func)
...
# ARMY TRANSPORT
arc_options = system.Option("ARC", system.coming_soon)  # ***
troop_transport_option = system.Option("TROOP TRANSPORT", system.coming_soon)  # ***
combat_aircraft_option = system.Option("COMBAT AIRCRAFT", system.coming_soon)  # ***
from_combat_transport_to_army = system.Option(system.underlined_text("BACK - ARMY"), system.pass_func)
...
# SOLDIERS
psychology_option = system.Option("PSYCHOLOGY", system.coming_soon)  # ***
equipment_option = system.Option("EQUIPMENT", system.coming_soon)  # ***
dislocation_option = system.Option("DISLOCATION", system.coming_soon)  # ***
habits_option = system.Option("HABITS", system.coming_soon)  # ***
sections_option = system.Option("SECTIONS", system.coming_soon)  # ***
from_soldiers_to_army = system.Option(system.underlined_text("BACK - ARMY"), system.pass_func)
...
from_logistics_to_hq = system.Option(system.underlined_text("BACK - HEADQUARTER"), system.pass_func)
...
from_army_to_hq = system.Option(system.underlined_text("BACK - HEADQUARTER"), system.pass_func)

army_options = (soldiers_option, combat_transport_option, from_army_to_hq)
army_menu = system.Menu("ARMY", army_options)

# OPERATIONS
reports_option = system.Option("REPORTS", system.coming_soon)  # ***
map_option = system.Option("MAP", fog_border)
move_option = system.Option("MOVE", system.coming_soon)  # ***
from_operations_to_hq = system.Option(system.underlined_text("BACK - HEADQUARTER"), system.pass_func)
...
from_hq_to_main_menu = system.Option(system.underlined_text("BACK - MAIN MENU"), system.pass_func)
...
quit_option = system.Option(system.underlined_text("QUIT"), system.pass_func)
