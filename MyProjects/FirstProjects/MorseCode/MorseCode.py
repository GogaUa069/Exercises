...
def short_beep():
    pygame.init()
    pygame.mixer.music.load(r"D:\PythonProjects\MySqlConnector\pythonProject1\MyProjects\FirstProjects\MorseCode\Audio\beep.wav")
...
def long_beep():
    pygame.init()
    pygame.mixer.music.load(r"D:\PythonProjects\MySqlConnector\pythonProject1\MyProjects\FirstProjects\MorseCode\Audio\long_beep.wav")
    pygame.mixer.music.play()
    while pygame.mixer.music.get_busy():
        pygame.time.Clock().tick(10)
