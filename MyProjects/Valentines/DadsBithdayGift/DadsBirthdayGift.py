...
pygame.init()
pygame.mixer.music.load(r"D:\PythonProjects\MySqlConnector\pythonProject1\MyProjects\Valentines\DadsBithdayGift\Audio\happy_birthday_jazz.wav")
pygame.mixer.music.play(-1)


t1 = "\033[34m{}".format("Happy Birthday to You!")
t2 = "\033[32m{}".format("Happy Birthday to You!")
t3 = "\033[33m{}".format("Happy Birthday Dear Daddy...")
